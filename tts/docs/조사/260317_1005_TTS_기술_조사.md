...
- 현재 active 실행 계획은 `tts/docs/보고서/260319_1052_TTS_커스텀_학습_계획_v1.md`를 기준으로 본다.
- 현재 training feasibility audit 요약은 `tts/docs/보고서/260319_1100_TTS_학습_가능성_점검.md`를 기준으로 본다.
- 현재 active 방향은 아래다.
...
- `tts/docs/조사/260318_1708_TTS_한국어_조사.md`
