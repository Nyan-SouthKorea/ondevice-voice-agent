...
- 용도: `wake_word/train/04_extract_features.py`, `05_train.py`, `06_export_onnx.py`, `stt/stt_demo.py` 최소 실행 검증
...
`openai-whisper`를 사용해 `stt/stt_demo.py`가 Jetson에서 실제로 뜨는지 확인한다.
